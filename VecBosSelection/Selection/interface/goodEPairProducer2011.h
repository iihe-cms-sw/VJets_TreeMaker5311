...
goodEPairProducer2011::goodEPairProducer2011 (const edm::ParameterSet & parameters)
{
   ...
   pflowMuCollection_         = parameters.getUntrackedParameter<edm::InputTag>("pflowMuCollection",edm::InputTag("particleFlow"));
   theMuCollectionLabel       = parameters.getUntrackedParameter<edm::InputTag>("muonCollection",edm::InputTag("patMuons"));
