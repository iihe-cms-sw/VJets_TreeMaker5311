...
_defaultSequence             = 'patDefaultSequencePFlow'
...
class SwitchOnTriggerMatching( ConfigToolBase ):
    ...
    def toolCode( self, process ):
	    ...
	    print ' Switch on PAT trigger information if neededSwitch on PAT trigger information if needed '
            print '%s():'%( self._label )
        ...
        for matcher in triggerMatchers:
	    print " electron trigger matchers TEST",matcher
        ...
        if len( matchers ) > 0:
		    ...
		    print " electron trigger matchers TEST"
...
class SwitchOnTriggerMatchingStandAlone( ConfigToolBase ):
    ...
    def toolCode( self, process ):
        ...
        if triggerProducer not in _modulesInSequence( process, sequence ):
            ...
            print _longLine
	    print 'check moduleInSeq', triggerProducer
    ...
    def toolCode( self, process ):
	    ...
	    print objects
            ...
            for step in range( steps ):
                ...
                dictEmbedders[ coll + "PFlow" ] = dictPatObjects[ objects ]
		print " Seva dictEmbedders:", dictPatObjects[ objects ], coll, objects
                if objects is 'Jets':
	    ...
	    print " bbbb", trigMchMod
            ...
            if matcher not in _modulesInSequence( process, sequence ) and not matchingOn:
                ...
                print _longLine
		print ' seguence moj: ', sequence, triggerProducer, matcher
	    ...
	    print " check source for trigger"
            print " SRC:", srcInput
